...
const DesktopNav: React.FC<NavbarProps> = ({ items }) => {
  ...
  return (
    <div className="col-span-12 w-full flex justify-center items-center h-20">
      <nav className="navbar h-20 hidden md:flex items-center space-grotesk max-w-300 w-full relative">
